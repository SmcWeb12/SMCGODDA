    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <nav className="sticky top-0 bg-blue-500 p-4 shadow-md z-10">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <ul className="hidden md:flex space-x-4">
            ...
            <li><a href="https://smcmathquiz.vercel.app/home" target="_blank" rel="noopener noreferrer" className="text-white hover:text-yellow-300">Math Quiz</a></li>
            <li><a href="https://smc-gk-gs-godda.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-yellow-300">GK-GS</a></li>
            <li><Link to="/courses" className="text-white hover:text-yellow-300">Courses</Link></li>
            <li><button onClick={handleLoginClick} className="text-white hover:text-yellow-300">Login</button></li>
          </ul>
        </div>
      </nav>
      ...
      <header className="relative bg-cover bg-center animate__animated animate__fadeIn" style={{ backgroundImage: `url('your-image.jpg')` }}>
        ...
        <div className="relative z-10 text-white text-center py-20">
          ...
          <button onClick={handleLoginClick} className="mt-8 bg-yellow-500 hover:bg-yellow-400 text-white font-bold px-6 py-3 rounded-lg transition duration-300">Join Us Today</button>
        </div>
      </header>
